"""
Django settings for simple_todo_list_app_2 project.
...
ROOT_URLCONF = 'simple_todo_list_app_2.urls'
...
WSGI_APPLICATION = 'simple_todo_list_app_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "simple todo list app Support <support@simple-todo-list-app-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "simple_todo_list_app_2 API",
    "DESCRIPTION": "API documentation for simple_todo_list_app_2 App",
    "VERSION": "v1",
}
